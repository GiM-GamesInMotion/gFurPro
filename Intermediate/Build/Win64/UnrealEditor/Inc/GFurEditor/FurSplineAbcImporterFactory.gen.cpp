...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFurSplineAbcImporterFactory_Statics::Class_MetaDataParams[] = {
	...
	UClass* Z_Construct_UClass_UFurSplineAbcImporterFactory()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UFurSplineAbcImporterFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UFurSplineAbcImporterFactory, 3534122330);
