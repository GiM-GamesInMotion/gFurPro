...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UFurSplineImporterFactory()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UFurSplineImporterFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UFurSplineImporterFactory, 3018447208);
