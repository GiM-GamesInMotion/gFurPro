...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFurSplines_Statics::NewProp_Threshold = { "Threshold", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFurSplines, Threshold), METADATA_PARAMS(Z_Construct_UClass_UFurSplines_Statics::NewProp_Threshold_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFurSplines_Statics::NewProp_Threshold_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFurSplines_Statics::NewProp_ImportTransformation_MetaData[] = {
		{ "ModuleRelativePath", "Public/FurSplines.h" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UFurSplines_Statics::NewProp_ImportTransformation = { "ImportTransformation", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFurSplines, ImportTransformation), METADATA_PARAMS(Z_Construct_UClass_UFurSplines_Statics::NewProp_ImportTransformation_MetaData, ARRAY_COUNT(Z_Construct_UClass_UFurSplines_Statics::NewProp_ImportTransformation_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UFurSplines, 2805345287);
