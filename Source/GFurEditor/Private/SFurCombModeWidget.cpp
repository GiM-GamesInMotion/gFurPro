...
TSharedPtr<SWidget> SFurCombModeWidget::CreateToolBarWidget()
{
	FToolBarBuilder ModeSwitchButtons(MakeShareable(new FUICommandList()), FMultiBoxCustomization::None);
	{
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.Length"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.AverageLength"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.Bend"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.Clump"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.Twist"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.Noise"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.Relax"), EUserInterfaceActionType::ToggleButton);
		...
		ModeSwitchButtons.AddToolBarButton(FUIAction(FExecuteAction::CreateLambda([=]()
		{
			...
			FSlateIcon("gFurStyleSet", "gFur.AddRemove"), EUserInterfaceActionType::ToggleButton);
	}
